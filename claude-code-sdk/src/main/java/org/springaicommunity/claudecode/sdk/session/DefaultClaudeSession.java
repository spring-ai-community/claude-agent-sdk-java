...
package org.springaicommunity.claudecode.sdk.session;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springaicommunity.claudecode.sdk.exceptions.TransportException;
import org.springaicommunity.claudecode.sdk.exceptions.ClaudeSDKException;
import org.springaicommunity.claudecode.sdk.hooks.HookCallback;
import org.springaicommunity.claudecode.sdk.hooks.HookRegistry;
import org.springaicommunity.claudecode.sdk.mcp.McpMessageHandler;
import org.springaicommunity.claudecode.sdk.mcp.McpServerConfig;
import org.springaicommunity.claudecode.sdk.parsing.ParsedMessage;
import org.springaicommunity.claudecode.sdk.streaming.BlockingMessageReceiver;
import org.springaicommunity.claudecode.sdk.streaming.MessageReceiver;
import org.springaicommunity.claudecode.sdk.streaming.MessageStreamIterator;
import org.springaicommunity.claudecode.sdk.streaming.ResponseBoundedReceiver;
import org.springaicommunity.claudecode.sdk.transport.BidirectionalTransport;
...
import org.springaicommunity.claudecode.sdk.types.control.ControlRequest;
import org.springaicommunity.claudecode.sdk.types.control.ControlResponse;
import org.springaicommunity.claudecode.sdk.types.control.HookInput;
import org.springaicommunity.claudecode.sdk.types.control.HookOutput;
import org.springaicommunity.claudecode.sdk.permission.PermissionResult;
import org.springaicommunity.claudecode.sdk.permission.ToolPermissionCallback;
import org.springaicommunity.claudecode.sdk.permission.ToolPermissionContext;
...
public class DefaultClaudeSession implements ClaudeSession {
	...
	public DefaultClaudeSession(Path workingDirectory) {
		this(workingDirectory, CLIOptions.builder().build(), Duration.ofMinutes(10), null, null);
	}
	 ...
	 */
	public DefaultClaudeSession registerHook(org.springaicommunity.claudecode.sdk.types.control.HookEvent event,
	...
	public static class Builder {
		...
		public DefaultClaudeSession build() {
			...
			return new DefaultClaudeSession(workingDirectory, options, timeout, claudePath, hookRegistry);
		}
