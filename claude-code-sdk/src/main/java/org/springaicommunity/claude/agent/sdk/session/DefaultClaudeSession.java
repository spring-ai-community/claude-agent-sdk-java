...
package org.springaicommunity.claude.agent.sdk.session;
...
public class DefaultClaudeSession implements ClaudeSession {
	 ...
	 */
	public DefaultClaudeSession registerHook(org.springaicommunity.claude.agent.sdk.types.control.HookEvent event,
