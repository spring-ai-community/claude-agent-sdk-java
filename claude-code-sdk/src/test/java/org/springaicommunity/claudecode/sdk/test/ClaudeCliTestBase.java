...
package org.springaicommunity.claudecode.sdk.test;
...
public abstract class ClaudeCliTestBase {
	...
	static void discoverClaudeCli() {
		try {
			claudeCliPath = org.springaicommunity.claudecode.sdk.config.ClaudeCliDiscovery.discoverClaudePath();
			logger.info("Claude CLI tests will use executable at: {}", claudeCliPath);
		}
		catch (org.springaicommunity.claudecode.sdk.config.ClaudeCliDiscovery.ClaudeCliNotFoundException e) {
